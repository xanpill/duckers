<?php
    ...
    if (isset($_SESSION['id'])) {
        ...
        if ($_POST['name'] != "" AND $_POST['logo'] != ""  AND $_POST['bg'] != "" AND $_POST['phone'] != "" AND $_POST['main_color'] != "" AND $_POST['sec_color'] != ""  AND $_POST['contact'] != ""  AND $_POST['bg_ann'] != ""  AND $_POST['tx_ann'] != ""  AND $_POST['des'] != "") {
            ...
            if ($q_1->rowCount() >= 1) {
                ...
                $insert = dd_q("UPDATE setting SET 
                    ...
                    sec_color = ? , contact = ? , des = ? , logo = ?, ann = ? , fee = ? , bg_ann = ? , tx_ann = ? , webhook_dc = ?
                ", [
                    $_POST['name'],
                    $_POST['bg'],
                    $_POST['phone'],
