...
<div class="container-fluid bb p-2 col-lg-10 col-10" style="background-color:#fafafa;">


        <div class="container-fluid ps-3 pe-3 pb-3" style="border-radius:1vh;">
        
        <div class="p-2">
            <h5 class="m-0"><h5 class=" mb-2 mt-2" style="color:#363636;">
        ...
        <div class=" m-0" style="background-color:#fafafa" >
            ...
            <div class="table-responsive">
                <table class="table  table-striped " id="table" >
                    ...
                    <tbody style="color:#2c2c2c;">
                        ...
                        ?>
                            <tr>
                                <td style="color:#363636; font-size:13px;" ><?=$data->name;?></td>
                                <td style="color:#363636; font-size:13px;"><button class="btn  bg-main w-100 mb-2 view-info-btn text-white" data-toggle="modal" data-target="#appInfoModal" data-info="Email : <?= htmlspecialchars($data->email); ?> | Password : <?= htmlspecialchars($data->password); ?>"><i class="fa-regular fa-search"></i>&nbsp;ดูข้อมูล</button></td>
                                <td class="text-center " style=" color:#363636; font-size:13px;"><a style="width: 10rem;" type="button" class="btn btn-outline-secondary" target="_blank" data-toggle="modal" data-target="#report<?=$data->id;?>" href="#"><i class="fa fa-wrench"></i> แจ้งปัญหา</a></td>
                                <td class="text-center" style="color:#363636; font-size:13px;"><?=$data->time;?></td>
                            </tr>
                        <!-- report แจ้งปัญหา -->
