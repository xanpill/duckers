...
<script>
    ...
    $("#save_btn").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'system/backend/service_product_update.php',
            data: formData,
            contentType: false,
            processData: false,
        }).done(function(res) {
    ...
    $("#insert_btn").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'system/backend/service_product_insert.php',
            data: formData,
            contentType: false,
            processData: false,
        }).done(function(res) {
    ...
    function get_detail(id) {
        ...
        $.ajax({
            type: 'POST',
            url: 'system/backend/call/service_product_detail.php',
            data: formData,
            contentType: false,
            processData: false,
        }).done(function(res) {
    ...
    function del(id, username) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'system/backend/service_product_del.php',
                    data: formData,
                    contentType: false,
                    processData: false,
                }).done(function(res) {
