...
<div class="container-sm mt-2 col-lg-10 col-10 shadow-sm p-4 mb-4" style="background-color:#f3f3f3; border-radius:1vh;">
        ...
        <table id="table" class="table mt-2">
            <thead class="table-dark bg-dark ">
                <tr class="">
                    ...
                    <th scope="col" class="ps-3 text-center" style="color:#eaac13;"> โอกาสออก</th>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class="text-center" style="font-size:13px; color:#464646"><?php echo htmlspecialchars($row['password']);?></td>
